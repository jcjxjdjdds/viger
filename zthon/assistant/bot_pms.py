...
async def bot_start(event):
    ...
    custompic = gvarstatus("BOT_START_PIC") or "https://graph.org/file/7b0cb266c7f43002c9bbd.jpg"
    if chat.id != Config.OWNER_ID:
        customstrmsg = gvarstatus("START_TEXT") or " ⌯╼═══❬ ᥲ️fᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ 𖡨 ❭═══╾⌯\n\n🎤╖ أهلآ بك عزيزي أنا بوت » أفاتار\n\n⚙️╢ وظيفتي حماية المجموعات\n\n✅╢ لتفعيل البوت عليك اتباع مايلي\n\n🔘╢ أضف البوت إلى مجموعتك\n\n⚡️╜ أرفعه » مشرف\n\n  ⌯╼═══❬ ᥲ️fᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ 𖡨 ❭═══╾⌯"
        if customstrmsg is not None:
            ...
            start_msg = f"**❈╎مـرحباً بـك عزيـزي  {mention} **\
                        ...
                        \n\n**❈╎البـوت خـاص بسـورس :** [ᥲ️᥎ᥲ️ƚᥲ️ᖇ Ⴆ᥆ƚ 𖡨](https://t.me/Y_U_D_s_bot)"
        buttons = [
            (
                Button.url("قنـاة السـورس", "https://t.me/source_av"),
                Button.url(
                    "مطـور السـورس",
                    "https://t.me/DIV_MUHAMED",
                ),
            )
        ]
    else:
        start_msg = "⌯╼═══❬ ᥲ️fᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ 𖡨 ❭═══╾⌯\n\n🎤╖ أهلآ بك عزيزي أنا بوت » أفاتار\n\n⚙️╢ وظيفتي حماية المجموعات\n\n✅╢ لتفعيل البوت عليك اتباع مايلي\n\n✨╢ أضف البوت إلى مجموعتك\n\n🔘╢ أرفعه » مشرف\n\n📖╜ لرؤيـة الاوامـر ارسل :  /samir\n\n ⌯╼═══❬ ᥲ️fᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ 𖡨 ❭═══╾⌯"
        buttons = None
    try:
        if custompic:
