...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == zedub.uid:
            buttons = [
                [Button.inline("⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯ ", data="MMM")],
                [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر البـــوت 🦾🤖](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر البـوت المسـاعد :**\n\n",
            buttons=[
                [
                ...
                [
                    ...
                    Button.inline("أفــاتــار", data="zedvr"),
                ],
                [
...
**- الوصـف :**
لـ عـرض اوامـر الاذاعـه الخاصـه بسـورس افـاتـار
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر المجمــوعــه 🛗](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯ 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/source_av) .
**- الامـر :**
**⪼** `.حذف رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر مكـافح التكــرار 🛡](t.me/source_av) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر المنــع 🚫](t.me/source_av) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر الاضـافه والتفليـش 👾](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر الفــارات 🧬](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر فــارات الوقتــي 🕰](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر فــارات حمايـة الخــاص 🛄](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر فــارات الفحـص 🏮](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر التسليـه والتحشيش 🏂🎃](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر التسليـه 🏂](t.me/source_av) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر التحشيش 🎃](t.me/source_av) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر الالـعــاب 🎮🎳](t.me/source_av) .
**- الامـر :**
**⪼** `.بلاي`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر الحســاب 🚹](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات الاوامـر المتعلقـه بالحسـاب :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر حمـايــة الخــاص 🛡](t.me/source_av) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - فــارات حمـايــة الخــاص 🛡](t.me/source_av) .
**⪼** `.اضف عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر المـرفقــات 🖥](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر الستـوريـات 🎆🏖](t.me/source_av) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/source_av) .
**- الامـر :**
**⪼** `.بنات`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر الادوات 💡](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات السـورس :**\n\n",
            buttons=[
                [
...
async def zed_help(event):
    await event.edit(
        "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - ادوات الروابــط 💡](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات الروابــط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر الاشتــراك الاجبــاري 🛗](t.me/source_av) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر الصيـد & التشيكـر ❇️](t.me/source_av) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر تجميـع النقـاط 💡](t.me/source_av) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر تجميــع النقــاط 🛂](t.me/source_av) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ ⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯  - اوامــر النشــر التلقــائي 🌐](t.me/source_av) .
**- الامـر :**
**⪼** `.تلقائي`
