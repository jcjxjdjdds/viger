...
ZelzalWF_cmd = (
    "𓆩 [ 𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝 - اوامـر الـردود / والتـرحيب](t.me/source_av) 𓆪\n\n"
    ...
    "\n 𓆩 [ 𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝𖢾](t.me/source_av) 𓆪"
)
...
async def on_all_snip_delete(event):
    ...
    if filters:
        ...
        await edit_or_reply(event, "𓆩  𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝 𝑭𝑰𝑳𝑻𝑬𝑹𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم حذف جـميع الــردود المضـافـهہ بنجـاح☑️**")
    else:
