...
ZelzalChecler_cmd = (
    "𓆩 [ 𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝 - اوامـر الصيـد والتشيكـر](t.me/source_av) 𓆪\n\n"
    ...
    try:
        ch = await zedub(
            functions.channels.CreateChannelRequest(
                title="avatar arabic - صيد افاتار",
                about="This channel to hunt username by - @source_av ",
            )
        )
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    event.chat_id,
                    "https://t.me/QQ_XxXxX/42",
                    caption="❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ - صيد أفـاتـار💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n**•────────────────────•**\n- By ❲ @FTTUTY ❳ ".format(
