...
ZelzalPRO_cmd = (
    "𓆩 [أوامـر الأذاعـةة -سـورس أفـاتـار](t.me/source_av) 𓆪\n\n"
    "**⎞𝟏⎝** `.للكروبات`  / `.للمجموعات`\n"
    "**بالــࢪد عــلى ࢪســالة نصيــه او وسـائــط تحتهــا نــص**\n"
    ...
    "\n 𓆩 [❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁](t.me/source_av) 𓆪"
)
...
async def gcast(event):
    ...
    if zedthon: #Write Code By T.me/zzzzl1l
        await edit_or_reply(event, "**⎉╎بالـࢪد عــلى ࢪسـالة او وسائـط**")
        return
    elif event.is_reply:
