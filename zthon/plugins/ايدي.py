...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت أفــاتــار"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "𖣐 "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋖⊶≭❂≭⊷⌯𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝 ⌯⊶≭❂≭⊷⋗"
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    zed_dev = (5680297831, 5566753847, 1400467850, 6174535740)
    zel_dev = (5680297831, 5566753847, 1400467850, 6174535740)
    if user_id == 5566753847 or user_id == 1400467850 or user_id == 5680297831:
