                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @DIV_MUHAMED\
                                  \n\n--------بـدء تتبـع سجـل أفــاتــار .م4 --------\
                        ...
                        link = "[ძᥱ᥎ ꧑᥆Ꮒᥲ️꧑ᥱძ ](https://t.me/DIV_MUHAMED)"
                        text = (
                            "**✘ تقـريـر اشعـار أفــاتــار ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار أفــاتــار ✘**\n\n "
                        link = "[ძᥱ᥎ ꧑᥆Ꮒᥲ️꧑ᥱძ ](https://t.me/DIV_MUHAMED)"
