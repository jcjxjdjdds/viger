...
'''
mm = '''
**- عليك الانضمـام في قنـاة السـورس اولاً**  @source_av
'''
...
keyboard = [
  ...
  [
    Button.url("𓏺𝗦َِ𝗼َِ𝘂َِ𝗿َِ𝗰َِ𝗲 َِ𝗰َِ𝗿َِ𝗶َِ𝘀َِ𝘁َِ𝗲َِ𝗻𓅛", "https://t.me/source_av")
    ]
]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if len(i) > 1:
        ...
        file.write(i + "\n\n**- بواسطـة سـورس افـاتـار @source_av**")
        file.close()
        await bot.send_file(event.chat_id, "session.txt")
        system("rm -rf session.txt")
      else:
        await event.reply(i + "\n\n**- شكـراً لـ استخدامـك سـورس سـورس افـاتـار ❤️** \n/hack", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply(i + "\n\n**- شكـراً لـ استخدامـك سـورس سـورس افـاتـار ❤️**", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("**- لقد تم انهـاء جميـع الجلسـات .. بنجـاح \n- شكـراً لـ استخدامـك ســورس سـورس افـاتـار**", buttons=keyboard)
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("قنـاة السـورس", "https://t.me/source_av")
        ]
    ]
