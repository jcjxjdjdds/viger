...
ZelzalCoins_cmd = (
    "[⌯╼═══❬ ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ ᥉᥆ᥙᖇᥴᥱ ❁ ❭═══╾⌯- اوامـر تجميـع النقـاط](t.me/source_av) 𓆪\n\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**@DIV_MUHAMED من البوتـات بالتحديثـات الجايـه .. اذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @DIV_MUHAMED**"
)
